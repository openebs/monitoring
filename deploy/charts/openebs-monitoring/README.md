...
| `kube-prometheus-stack.alertmanager.config`                                              | Provide YAML to configure Alertmanager.                                                                 | `{global: {resolve_timeout: 5m}, route: {group_by: [alertname, job, volName], group_wait: 30s, group_interval: 5m, repeat_interval: 4h, receiver: 'null'}, receivers: [{name: 'null'}], templates: [/etc/alertmanager/config/*.tmpl]}`                                                    |
...
| `customRules.pools.enabled`                                                   | Enables openebs pool rules                             | `true`                                              |
| `customRules.volumes.enabled`                                                   | Enables openebs volumes rules                             | `true`                                              |
