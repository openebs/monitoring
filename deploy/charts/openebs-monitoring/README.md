...
| `openebsMonitoringComponents.enabled`                                                   | Enabled installation of  openebs-addon only                                            | `false` |
| `openebsMonitoringComponents.grafana.openebsDashboardsEnabled`                                                   | Deploys openebs dashboards                                            | `true` |
| `openebsMonitoringComponents.grafana.sidecar.dashboards.enabled`                                | Allows grafana sidecar container to provision dashboards                            | `true`                                                    |
| `openebsMonitoringComponents.sidecar.dashboards.label`                                  | Updated labels for configmaps to be collected by grafana sidecars                           | `"grafana_dashboard"`                                     |
